...
#define NUM_SAMPLES					3 // Filter window width - Increase if you think data is noisy
...
#define NULL_READS2					75			// Increase if it detects too many intersections, decrease if ignoring intersections - CHANGE THIS LAST, its pretty good
// Lower value counts less black lines
#define LINEDETECT_K_NUM			0//10			// For Horizontal checks - dont fuck with
#define LINEDETECT_K_DEN			420			// Increase if not detecting horizontal lines, decrease vice versa
#define LINEDETECT_K_NUM_2			0//10			// DONT FUCK WITH
#define LINEDETECT_K_DEN_2			480			// Increase if its not detecting intersections, decrease if detecting too many
#define LINEDETECT_K_NUM_3			0//10			// For Slowing down
...
#define DELTA_T_CNST				12500//10000// The target change in time for the slowdown period as a func of DC
#define TARGET_DC					18			// Ending duty cycle after slowdown
...
#define NULLS						0
#define BLACKS						1
#define CALIBRATION_NUM_SAMP		2000         // Changing this changes our calibration times (how long it calibrates)
